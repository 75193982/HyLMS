...
public class SalaryPayDetail {
    ...
    private double allowanceDistance;
    ...
    public double getAllowanceDistance() {
		return allowanceDistance;
	}

	public void setAllowanceDistance(double allowanceDistance) {
		this.allowanceDistance = allowanceDistance;
	}
