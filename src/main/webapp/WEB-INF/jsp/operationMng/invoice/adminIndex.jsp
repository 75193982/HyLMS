							  ...
							  <div class="widget-main">
								...
								<div class="add-item extra-item" style="position:relative">
								     ...
								     <div class="input-group input-group-sm w75" >
										<input class="form-control" id="operateTime_add" style="height: 32px;" type="text" placeholder="请输入开票时间"/>
										<span class="input-group-addon">
											<i class="icon-calendar"></i>
										</span>									
									 </div>
							...
							<div class="widget-body">
							  <div class="widget-main">
								...
								<div class="add-item extra-item" style="position:relative">
								     ...
								     <div class="input-group input-group-sm w75">
										<input class="form-control" id="operateTime_edit" type="text" placeholder="请输入开票时间"/>
										<span class="input-group-addon">
											<i class="icon-calendar"></i>
										</span>									
									 </div>
