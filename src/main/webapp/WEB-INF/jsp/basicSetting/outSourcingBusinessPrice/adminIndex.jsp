...
<div class="page-content">
	...
	<div class="page-content">
		<div class="searchbox col-xs-12">
		   ...
		   <input id="fom_outSourcing" class="form-box" type="text" style="width: 130px" placeholder="请填写承运商"/>
		   <input id="fom_outSourcing_id" class="form-box" type="hidden" style="width: 240px" />
		 
			<label class="title">库&nbsp;&nbsp;&nbsp;区：</label>
			<select id="stockSearch" class="form-box" style="width: 130px"><option value="">请选择库区</option>	</select>
			<label class="title">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>
			<select id="brandNameSearch" class="form-box" style="width: 130px"><option value="">请选择品牌</option>	</select>
		   <label class="title">车&nbsp;&nbsp;&nbsp;型：</label>
		   <input id="carTypeSearch" class="form-box" type="text" style="width: 130px" placeholder="请填写车型"/>
		</div>
		<div class="searchbox col-xs-12">
		   <label class="title">供应商：</label>
		   <input id="supplierNameSearch" class="form-box" type="text" style="width: 130px" placeholder="请填写供应商"/>
			<label class="title">始发地：</label>
		   <input id="startAddressSearch" class="form-box" type="text" style="width: 130px" placeholder="请填写始发地"/>
		   <label class="title">目的省：</label>
		   <input id="endProvinceSearch" class="form-box" type="text" style="width: 130px" placeholder="请填目的省"/>
		   <label class="title">目的地：</label>
		   <input id="endAddressSearch" class="form-box" type="text" style="width: 130px" placeholder="请填写目的地"/>
							...
							<div class="widget-body">
								<div class="widget-main">
								   <div class="add-item extra-item">
								     ...
								     <select id="outSourcingName" class="form-control" onchange="getbrand(this,1);"></select>
								    </div>
								    <hr class="tree"></hr>
									<div class="add-item extra-item">
					    ...
					    <div class="widget-box dia-widget-box">
							<div class="widget-body">
								<div class="widget-main">
								   <div class="add-item extra-item">
								     <label class="title"><span class="red">*</span>承运商：</label>
								     <select id="eoutSourcingName" class="form-control"  onchange="getbrand(this,2);"></select>
								    </div>
								    <hr class="tree"></hr>
									<div class="add-item extra-item">
								     <label class="title"><span class="red">*</span>库区：</label>
...
function getbrand(e,index){
	...
	if(id=='-1'){
		...
		$.ajax({
			...
			data :JSON.stringify({outSourcingId:id}),
			contentType : "application/json;charset=UTF-8",
			dataType : 'JSON',
			success : function(data) {
				if (data && data.code == 200) {
...
function getbrandForOutSourcing(id,brandId){
	if(id=='-1'){
		var htmlEm ='<option value="-1">请先选择承运商</option>';
		$('#ebrandName').html(htmlEm);
		$('#ebrandName').val('-1');
	}else{
		$.ajax({
		...
		success : function(data) {
			if (data && data.code == 200) {
				...
				if(data.data.businessId!=null && data.data.businessId!=''){
					getbrandForOutSourcing(data.data.outSourcingId,data.data.businessId);
				}else{
					$('#ebrandName').val('-1');
				}
