			   ...
			   <div class="modal-dialog" style="padding-top:5%;">
				  <div class="modal-content">
					<div class="modal-header" style="padding:3px 10px;">
						...
						<h3 id="myModalLabel">配件出入库明细查看</h3>
					</div>
...
function loadTable(){
	$('#dynamic-table').DataTable( {
		"destroy": true,//如果需要重新加载的时候请加上这个
		 ...
		 "sAjaxSource": "${ctx}/operationMng/carAttachmentMng/getInoutList" , //获取数据的ajax方法的URL							 
		 ordering: false,	
			"oLanguage": {
...
function loadDeatilTable(){
	$('#detailtable').DataTable( {
		"destroy": true,//如果需要重新加载的时候请加上这个
		 ...
		 "bProcessing": true, //加载数据时显示正在加载信息
		 "bServerSide": true, //指定从服务器端获取数据
		 "sAjaxSource": "${ctx}/operationMng/carAttachmentMng/getDetailByParentId" , //获取数据的ajax方法的URL							 
		 ordering: false,	
			"oLanguage": {
				"sLengthMenu": "每页显示 _MENU_ 条记录",
				"sZeroRecords": "抱歉， 没有找到",
