	...
	<div class="page-content">
		...
		<div class="searchbox col-xs-12">			
		   ...
		   <!-- <select id="fom_status" class="form-box" style="width:170px;">
		   	...
		   	<label class="title">出库单号：</label>
			<input id="form_billNo" class="form-box" type="text" placeholder="请输入出库单号" style="width:170px;" />
...
function init(){
	...
	var myTable = $('#detailtable').DataTable({
		 ...
		 "sAjaxSource": "${ctx}/operationMng/trackTyreInOutMng/getListData" , //获取数据的ajax方法的URL							 
		 ordering: false,	
			"oLanguage": {
