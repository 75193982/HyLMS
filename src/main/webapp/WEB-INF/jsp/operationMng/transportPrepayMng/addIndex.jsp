...
<div class="page-content">
	...
	<div class="page-content">
		<div class="mng">
		   <div class="table-tit">新建装车预付申请单</div>
		   <div class="table-item">
		     ...
		     <div class="row newrow">
		          <div class="col-xs-1 pd-2">
			       ...
			       <div class="col-xs-5">
				       <div class="form-contr">
				          <input class="form-control" id="mobile" type="text"  readonly="readonly" placeholder="请输入联系电话" />
				       </div>
			       </div>
		       </div>
		     <!-- 第三列 -->
		     ...
		     <div id="detailList0" class="border-b-ff9a00 detailList">
		       <!-- 第五列 -->
		     <!-- <div class="row newrow">
		       <div class="col-xs-10 pd-2"></div>
		       <div class="col-xs-2">
		          <div class="form-contr-1">
		             <a class="delete-detail fr" onclick="removeDetail(this,0);"><i class="icon-minus-sign" style="display: inline-block;width: 20px;"></i>删除</a>
		          </div>
		       </div>
		     </div> -->
		     <div class="row newrow">
		       <div class="col-xs-1 pd-2">
			       <div class="lab-tit">
			          <label><span class="red">*</span>品牌:</label>
			       </div>
		       </div>
		       <div class="col-xs-5">
			       <div class="form-contr">
			          <select class="form-control carShopId" id="brandName0">
			          </select>
			       </div>
		       </div>
		       <div class="col-xs-1 pd-2">
		       ...
		       <div class="col-xs-5">
			       <div class="form-contr">
			          <input class="form-control" id="count0" type="text" placeholder="请输入台数" />
			       </div>
		       </div>
		     </div>
		     <!-- 第六列 -->
		     <div class="row newrow">
		       ...
		       <div class="col-xs-5">
			       <div class="form-contr">
			         <input class="form-control" id="startAddress0" type="text" placeholder="请输入起运地" />
			       </div>
		       </div>
		       <div class="col-xs-1 pd-2">
			       <div class="lab-tit">
		       ...
		       <div class="col-xs-5">
			       <div class="form-contr">
			          <input class="form-control" id="endAddress0" type="text" placeholder="请输入目的地" />
			       </div>
		       </div>
		     </div>
		     <!-- 第七列 -->
		     <div class="row newrow">
		       ...
		       <div class="col-xs-11">
			       <div class="form-contr">
			           <input class="form-control" id="remark0" type="text" placeholder="请输入备注" />
			       </div>
		       </div>
		      </div>
		     </div>
	            	...
	            	if(data.data!=null && data.data!=''){
	            		if(data.data.length>0){
	            			for(var i=0;i<data.data.length;i++){
	                			html +='<option value='+data.data[i]['id']+' data-driver='+data.data[i]['driver']+' data-mobile='+data.data[i]['mobile']+'>'+data.data[i]['no']+'</option>';
	                		}
	            		}
	            	}
	            	$('#carNumber').html(html);
...
function removeDetail(e,index){
 ...
 function dosave(){
	 ...
	 for(var i=0;i<detailList;i++){
	   ...
	   bootbox.confirm({ 
			  size: "small",
			  message: "确定要保存该装运预付申请单信息?", 
			  callback: function(result){
				  if(result){
						$.ajax({
							type : 'POST',
							url : '${ctx}/operationMng/transportPrepayMng/save',
