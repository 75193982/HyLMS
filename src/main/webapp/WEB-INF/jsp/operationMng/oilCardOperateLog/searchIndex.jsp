	...
	<div class="page-content">
		...
		<div class="searchbox col-xs-12">
		   <label class="title">使用人：</label>
		    <input id="fom_receiveUser" class="form-box" type="text" placeholder="请填写使用人(模糊查询)" onkeyup="searchSchedule(this)"/>
		    <input id="fom_receiveUser_hidden" class="form-box" type="hidden" />
		    <div id="selectItem8" class="selectItemhidden" style="height: 150px;width: 200px;">
					    ...
					    <div class="widget-box dia-widget-box">
							<div class="widget-body">
								<div class="widget-main">
									...
									<hr class="tree"></hr>
									<div class="add-item extra-itemSec">
										 <label class="title"><span class="red">*</span>确认金额：</label>
		 ...
		 $.ajax({
			...
			success : function(data) {
				if (data && data.code == 200) {	
					...
					$('#localSum').html('收入'+income.toFixed(2)+'元-支出'+outcome.toFixed(2)+'元 ='+sum+'元');
					$('#allSum').html('收入'+parseFloat(allincome).toFixed(2)+'元-支出'+parseFloat(alloutcome).toFixed(2)+'元 ='+allsum+'元');
				} else {
					 bootbox.alert(data.msg);
				}
