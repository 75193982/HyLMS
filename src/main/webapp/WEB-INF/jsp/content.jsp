...
<body class="white-bg">
	<div class="page-content">
		<div class="page-header">
			<h1> 首页 <small> <i class="icon-double-angle-right"></i> 首页 </small> </h1>
		</div>
		<!-- /.page-header -->
		<div class="page-content">
			<div class="first_pageLeft">
				<div class="row">
					<div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
						<div class="widget-box">
							<div class="widget-header widget-header-flat widget-header-small">
								<h5 class="widget-title">工作台</h5>
								<!-- <button type="button" class="btn blue" onclick="opendetil();">代办明细</button> -->
							</div>
									...
									<div class="tabbable">
										<ul class="nav nav-tabs padding-12 " id="myTab4">
											<li class="active"><a data-toggle="tab" href="#home4">
													<span id="waitingDo_all">待办</span>
											</a></li>
											<li><a data-toggle="tab" href="#profile4"> <span id="hasDo_all">已办</span></a></li>
										</ul>
										<div class="tab-content">
											<div id="home4" class="tab-pane in active">
												<table id="detailtable"
													class="table table-striped table-bordered table-hover novertical">
													<thead>
														<tr>
															<th>标题</th>
															<th>接收时间</th>
											...
											<div>
												<div class="widget-box dia-widget-box">
													<div class="widget-body">
														...
														<hr class="tree"></hr>
														<div class="add-item">
															<label class="title tobold">待审信息</label>
														</div>
														<!-- 运单信息 -->
														<div id="waybill_msg">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">类型：</label> <label
																	class="title col-xs-4" id="type_audit"></label> <label
																	class="title col-xs-2">运单编号：</label> <label
																	class="title col-xs-4" id="waybillNo_audit"></label>
															</div>
															<div id="hiddens1">
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">品牌：</label> <label
																		class="title col-xs-4" id="brand_audit"></label> <label
																		class="title col-xs-2">经销单位：</label> <label
																		class="title col-xs-4" id="carShopId_audit"></label>
																</div>
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">供应商：</label> <label
																		class="title col-xs-4" id="supplierId_audit"></label>
																</div>
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">发运日期：</label> <label
																		class="title col-xs-4" id="sendTime_audit"></label>
																</div>
															</div>
															<div id="hiddens2">
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">运输价格：</label> <label
																		class="title col-xs-4" id="amount_audit"></label> <label
																		class="title col-xs-2">接车联系人电话：</label> <label
																		class="title col-xs-4" id="receiveUserTelephone_audit"></label>
																</div>
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">接车联系人：</label> <label
																		class="title col-xs-4" id="receiveUser_audit"></label>
																	<label class="title col-xs-2">接车联系人手机：</label> <label
																		class="title col-xs-4" id="receiveUserMobile_audit"></label>
																</div>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">始发地：</label> <label
																	class="title col-xs-10" id="startAddress_audit"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">目的地：</label> <label
																	class="title col-xs-10" id="targetAddress_audit"></label>
															</div>
															<div id="hiddens4">
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">目的省 ：</label> <label
																		class="title col-xs-10" id="targetProvince_audit"></label>
																</div>
															</div>
															<div id="hiddens3">
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">公里数 ：</label> <label
																		class="title col-xs-10" id="distance_audit"></label>
																</div>
															</div>
															<hr class="tree"></hr>
															<div class="add-item-btn" id="detilbtn"
																style="margin-left: 0px;">
																<a class="add-itemBtn" onclick="getdetil();">运单明细</a>
															</div>
														</div>
														<!-- 调度单信息 -->
														<div id="scheduleBill_msg">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">调度单：</label> <label
																	class="title col-xs-4" id="scheduleBillNo_audit"></label>
																<!-- <label class="title col-xs-2">交车日期：</label><label class="title col-xs-4" id="receiveTime_audit"></label>	 -->
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12" id="fastsched">
																<label class="title col-xs-2">装运日期：</label> <label
																	class="title col-xs-4" id="shnsendTimes_audit"></label>																
															</div>
															<div class="add-item col-xs-12" id="schedatbill">
																<label class="title col-xs-2">装运日期：</label> <label
																	class="title col-xs-4" id="shnsendTime_audit"></label>
																<label class="title col-xs-2">交车日期：</label> <label
																	class="title col-xs-4" id="receiveTime_audit"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">台数：</label> <label
																	class="title col-xs-4" id="schamount_audit"></label> <label
																	class="title col-xs-2">装运车号：</label> <label
																	class="title col-xs-4" id="carNumber_audit"></label>
															...
															<div class="add-item-btn" id="detilbtns" style="margin-left: 0px;">
																<a class="add-detilBtn" onclick="getdetils();">调度单明细</a>
															</div>
														...
														<div id="changeCar_msg">
															...
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">原因：</label> <label class="title col-xs-4" id="reason_changeCar"></label>
																<!-- <label class="title col-xs-2">目的地：</label><label class="title col-xs-4" id="endAddress_audit"></label>		 -->
															</div>
															<hr class="tree"></hr>
														...
														<div id="Prepay_msg">
															...
															<div class="add-item-btn" id="prepay_detilbtn" style="margin-left: 0px;">
																<a class="add-itemBtn" onclick="getPrepaydetils();" style="width: 130px;">装运预付申请明细</a>
															</div>
														</div>
														<!-- 轮胎出入库信息 -->
														...
														<div id="portCost_msg">
															...
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">报账现金：</label> 
																<label class="title col-xs-4" id="sumMoney_port"></label> 
																<label class="title col-xs-2">报账油费：</label> 
																<label class="title col-xs-4" id="oilMoney_port"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">预付现金：</label> 
																<label class="title col-xs-4" id="prepayCash_port"></label> 
																<label class="title col-xs-2">预付油费：</label> 
																<label class="title col-xs-4" id="oilAmount_port"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">应付现金：</label> 
																<label class="title col-xs-4" id="sumMoneyActual_port"></label> 
																<label class="title col-xs-2">应付油费：</label> 
																<label class="title col-xs-4" id="oilMoneyActual_port"></label>
															</div>
															<div id="needmoney">
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																	<label class="title col-xs-2">折现后应付现金：</label> 
																	<label class="title col-xs-4" id="sumMoneyDiscount_need"></label>
																	<label class="title col-xs-2">折现后应付油费：</label> 
																	<label class="title col-xs-4" id="oilMoneyDiscount_need"></label>

																</div>																
															</div>
															<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																    <label class="title col-xs-2">实付现金：</label> 
																	<label class="title col-xs-1">当月：</label> 
																	<label class="title col-xs-3" id="balanceCash_port"></label> 
																	<label class="title col-xs-2">预付油费：</label> 
																	<label class="title col-xs-4" id="balanceOil_port"></label>
																</div>
																<hr class="tree"></hr>
																<div class="add-item col-xs-12">
																    <label class="title col-xs-2"></label> 
																	<label class="title col-xs-1">下月：</label> 
																	<label class="title col-xs-3" id="balanceNextCash_port"></label> 																	
																</div>
															<hr class="tree"></hr>
															<div class="add-item-btn" id="portCost_detilbtn" style="margin-left: 0px;">
																<a class="add-itemBtn" onclick="getportCostdetils();" style="width: 140px;">装费用核算申请明细</a>
															</div>
														</div>
														<!-- 办公费用申请信息 -->
														<div id="officeapply_msg">
															...
															<div class="add-item col-xs-12">
																...
																<label class="title col-xs-4" id="process_off"></label> <label
																	class="title col-xs-2">项目名称：</label> <label
																	class="title col-xs-4" id="itemName_off"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">金额：</label> <label
																	class="title col-xs-4" id="amount_off"></label> <label
																	class="title col-xs-2">预付现金：</label> <label
																	class="title col-xs-4" id="cashAdvance_off"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">开始时间：</label> <label
																	class="title col-xs-4" id="startTime_off"></label> <label
																	class="title col-xs-2">结束时间：</label> <label
																	class="title col-xs-4" id="endTime_off"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">备注：</label> <label
																	class="title col-xs-10" id="mark_off"></label>
															</div>
														</div>
														<!-- 轮胎更换信息 -->
														<div id="trackchange_msg">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">装运车号：</label> <label
																	class="title col-xs-4" id="carNumber_chge"></label> <label
																	class="title col-xs-2">申请时间：</label> <label
																	class="title col-xs-4" id="applyTime_chge"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">原轮胎：</label> <label
																	class="title col-xs-2" id="oldNo_chge"></label><label
																	class="title col-xs-2" id="oldfilename-view"></label> <label
																	class="title col-xs-2">新轮胎：</label> <label
																	class="title col-xs-2" id="newNo_chge"></label><label
																	class="title col-xs-2" id="newfilename-view"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">备注：</label> <label
																	class="title col-xs-10" id="mark_chge"></label>
															</div>
														</div>
														<!-- 折损反馈信息 -->
														<div id="carfeedback_msg">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">装运时间：</label> <label
																	class="title col-xs-4" id="transportTime_fbck"></label>
																<label class="title col-xs-2">车型：</label> <label
																	class="title col-xs-4" id="carType_fbck"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">经销单位：</label> <label
																	class="title col-xs-4" id="carShopId_fbck"></label> <label
																	class="title col-xs-2">联系方式：</label> <label
																	class="title col-xs-4" id="linkMobile_fbck"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">备注：</label> <label
																	class="title col-xs-10" id="mark_fbck"></label>
															</div>
														</div>
														<!-- 折损出库信息 -->
														<div id="cardagout_msg">
															...
															<div class="add-item row">
																<label class="title col-xs-2">申请时间：</label> <label
																	class="title col-xs-4" id="insertTime_dagout"></label>
																<label class="title col-xs-2">出库原因：</label> <label
																	class="title col-xs-4" id="mark_dagout"></label>
															</div>
															<div class="add-item row">
																<label class="title">折损车</label>
																<table id="cardagout_dagout"
														...
														<div id="cardamgcost_msg">
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">处理类型：</label> <label
																	class="title col-xs-4" id="type_damgcost"></label> <label
																	class="title col-xs-2">调度单号：</label> <label
																	class="title col-xs-4" id="scheduleno_damgcost"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">开户行：</label> <label
																	class="title col-xs-4" id="bankName_damgcost"></label>
																<label class="title col-xs-2">名称：</label> <label
																	class="title col-xs-4" id="accountName_damgcost"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">账号：</label> <label
																	class="title col-xs-4" id="accountNo_damgcost"></label>
																<label class="title col-xs-2">总金额：</label> <label
																	class="title col-xs-4" id="amount_damgcost"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">是否走保险：</label> <label
																	class="title col-xs-4" id="insuranceFlag_damgcost"></label>
																<label class="title col-xs-2">情况说明：</label> <label
																	class="title col-xs-4" id="mark_damgcost"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">上传凭证：</label> <label
																	class="title col-xs-10" id="file_damgcost"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item-btn" id="damgcost_detilbtn"
																style="margin-left: 0px;">
																<a class="add-itemBtn" onclick="getdamgcostdetil();"
																	style="width: 130px;">折损车明细</a>
															</div>
														</div>
														<!-- 发车指令信息 -->
														<div id="sendCar_msg">
															...
															<div class="add-item row">
																<label class="title col-xs-2">装运车号：</label> <label
																	class="title col-xs-4" id="carNumber_sedcar"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item row">
																<label class="title col-xs-2">始发地：</label> <label
																	class="title col-xs-4" id="startAddress_sedcar"></label>
																<label class="title col-xs-2">目的地：</label> <label
																	class="title col-xs-4" id="endAddress_sedcar"></label>
															</div>
														</div>
														<!-- 办公费用申请信息-新 -->
														...
														<div class="add-item" id="hidden7">
															<label class="title tobold">审核信息</label>
														</div>
														...
														<div id="hiddenpre">
															...
															<div class="add-item col-xs-12" style="margin-bottom: 10px; padding-top: 15px;">
																...
																<div class="col-xs-2" style="margin-left:-30px;width: 180px;">
																	<input class="form-control" id="balanceOil_audit" type="text" placeholder="请输入实付油费" />
																</div>
															</div>
														</div>
														...
														<div class="add-item-btn" id="auditBtn">
															...
															<!-- <a class="add-itemBtn btnOk" onclick="waybillaudit('Y');" id="ybtn" style="margin-left: 180px;">通过</a>
                                       <a class="add-itemBtn btnOk" onclick="waybillaudit('N');" id="nbtn">不通过</a> -->
															<!-- <a class="add-itemBtn btnOk" onclick="refresh();">取消</a> -->
														</div>
														<div class="add-item-btn" id="confirmBtn">
															...
															<!-- <a class="add-itemBtn btnOk" onclick="waybillconfirm();" id="cbtn" style="margin-left: 180px;">确认</a> -->
															<!-- <a class="add-itemBtn btnOk" onclick="refresh();">取消</a> -->
														</div>
														<div id="msglble" style="height: 70px; margin-top: 30px;">
															<label class="title"> <span class="red">*请根据《操作日志信息》中的审核意见，修改后重新提交</span></label>
															<a onclick="newpage();" style="margin-left: 30px;"> <img src="${ctx}/staticPublic/images/hand.png" style="width: 30px; height: 30px;" /></a>
															<!-- <button class="btn btn-app btn-pink btn-sm" onclick="openoper();"> <i class="ace-icon fa fa-share bigger-200"> </i> </button> -->
														</div>
														<%-- <div id="msglblereview" style="height: 70px; margin-top: 30px;" display=none>
															<label class="title"> <span class="red">*待审信息，请点击</span></label>
															<!-- 驾驶员费用报销审核 -->
															<a onclick="newpagereview();" style="margin-left: 30px;">
															<img src="${ctx}/staticPublic/images/hand.png" style="width: 30px; height: 30px;" />
															</a>
															<!-- <button class="btn btn-app btn-pink btn-sm" onclick="openoper();"> <i class="ace-icon fa fa-share bigger-200"> </i> </button> -->
														</div> --%>
													</div>
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div id="hiddenes1">
															...
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">品牌：</label> <label
																	class="title col-xs-4" id="brand_view"></label> <label
																	class="title col-xs-2">经销单位：</label> <label
																	class="title col-xs-4" id="carShopId_view"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">供应商：</label> <label
																	class="title col-xs-4" id="supplierId_view"></label>
															</div>
														</div>
														<hr class="tree"></hr>
														<div class="add-item col-xs-12">
															<label class="title col-xs-2">下单日期：</label> <label
																class="title col-xs-4" id="sendTime_view"></label>
														</div>
														<div id="hiddenes2">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">运输价格：</label> <label
																	class="title col-xs-4" id="amount_view"></label> <label
																	class="title col-xs-2">接车联系人电话：</label> <label
																	class="title col-xs-4" id="receiveUserTelephone_view"></label>
															</div>
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">接车联系人：</label> <label
																	class="title col-xs-4" id="receiveUser_view"></label> <label
																	class="title col-xs-2">接车联系人手机：</label> <label
																	class="title col-xs-4" id="receiveUserMobile_view"></label>
															</div>
														</div>
														<hr class="tree"></hr>
														<div class="add-item col-xs-12">
															<label class="title col-xs-2">始发地：</label> <label
																class="title col-xs-10" id="startAddress_view"></label>
														</div>
														<hr class="tree"></hr>
														<div class="add-item col-xs-12">
															<label class="title col-xs-2">目的地：</label> <label
																class="title col-xs-10" id="targetAddress_view"></label>
														</div>
														<div id="hiddenes4">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">目的省：</label> <label
																	class="title col-xs-10" id="targetProvince_view"></label>
															</div>
														</div>
														<div id="hiddenes3">
															<hr class="tree"></hr>
															<div class="add-item col-xs-12">
																<label class="title col-xs-2">公里数：</label> <label
																	class="title col-xs-10" id="distance_view"></label>
															</div>
														</div>
														<hr class="tree"></hr>
														<div class="add-item col-xs-12">
															<label class="title col-xs-2">附件：</label><label
																class="title col-xs-10" id="file_view"></label>
														</div>
														<hr class="tree"></hr>
														<div class="add-item">
															<label class="title">商品车信息：</label>
															<table id="cardetable_view"
																class="table table-striped table-bordered table-hover">
																<thead>
																	<tr>
																		<th>序号</th>
														...
														<div class="add-item">
															...
															<table id="attachmentdetable_view"
																class="table table-striped table-bordered table-hover">
																<thead>
																	<tr>
																		<th>序号</th>
												...
												<div class="widget-body">
													<div class="widget-main">
														<div class="mng">
															<div class="table-tit">
																查看调度单
																<!-- <i class="icon-undo" style="display: inline-block;width: 20px;"></i> -->
															</div>
															<div class="table-item">
																...
																<div class="row row-btn-tit" id="carDetail">
																	<div class="col-xs-2 pd-2">
																		<div class="row-tit">详细信息</div>
																	</div>
																	<div class="col-xs-10" style="text-align: right; margin-top: 3px;">
																		<!-- <a class="table-edit" onclick="doprint();"
														...
														<div class="mng">
															...
															<div class="table-item">
																...
																<div class="row newrow">
																	...
																	<div class="col-xs-5">
																		<div class="form-contr">
																			<p id="bankAccount_pre"
																				class="form-control no-border"></p>
																		</div>
																	</div>
																	<div class="col-xs-1 pd-2">
																		<div class="lab-tit">
																...
																<div class="row newrow">
																	...
																	<div class="col-xs-2">
																		<div class="form-contr">
																			<a class="backbtn" onclick="dopreback();"> <i
																				class="icon-undo"
			  ...
			  <div class="row newrow">
			       ...
			       <div class="col-xs-4">
			           <div class="form-contr">
			              <p class="form-control no-border" id="oilMoneyNew"></p>
								...
								<!-- 折损费用申请 -->
								<div class="modal fade modal-reset" id="modal-view"
									tabindex="-1" role="dialog" data-backdrop="static"
									style="width: 850px;">
									<div class="modal-dialog dia-widget-box"
												...
												<div class="widget-box dia-widget-box">
													<div class="widget-body">
														<div class="widget-main">
															...
															<hr class="tree"></hr>
															<div class="add-item extra-item1 extra-itemS">
																<label class="title" style="width: 95px;">是否走保险：</label>
																<p id="sinsuranceFlag"></p>
															</div>
															<hr class="tree"></hr>
															<div class="add-item extra-item1 extra-itemS">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 widget-container-col ">
						<div class="widget-box">
							<div class="widget-header widget-header-flat widget-header-small">
								<h5 class="widget-title">我的备忘</h5>
								<!-- <button type="button" class="btn blue" onclick="opendetil();">代办明细</button> -->
							</div>
							<div class="widget-body" style="height: 350px;">
								<div class="widget-main">
									<div class="well well-sm">
										<a class="backbtn" onclick="doaddreminder();"
											style="width: 100px; margin-left: auto; height: 30px; line-height: 30px;">
											<i class="icon-plus-sign"
											style="display: inline-block; width: 20px;"></i>添加
										</a>
									</div>
									...
									<div class="modal fade" id="modal-reminder" tabindex="-1"
										role="dialog" data-backdrop="static">
										<div class="modal-header">
											<button class="close" type="button" data-dismiss="modal">×</button>
											<h3 id="myModalLabel">备忘信息</h3>
										</div>
										<div class="modal-body">
											<div>
												<div class="widget-box dia-widget-box">
														...
														<div class="widget-main">
															<div class="add-item ">
																...
																<textarea rows="4" cols="4" class="form-control"
																	id="reminder_mark" placeholder="请输入备忘信息"></textarea>
															</div>
															<hr class="tree"></hr>
															<div class="add-item-btn" id="reminderaddBtn"
																style="margin-left: 150px;">
																<a class="add-itemBtn btnOk" onclick="dosavereminder()">保存</a>
																<a class="add-itemBtn btnOk" onclick="doclosereminder()">关闭</a>
															</div>
															<div class="add-item-btn" id="remindereditBtn"
																style="margin-left: 150px;">
																<a class="add-itemBtn btnOk" onclick="doupreminder()">保存</a>
																<a class="add-itemBtn btnOk"
																	onclick="dodeletereminder()">删除</a>
															</div>
														</div>
													</div>
												</div>
			...
			<div class="first_pageRight">
				<div class="row">
					<div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
						<div class="widget-box">
							<div class="widget-header widget-header-flat widget-header-small">
								<h5 class="widget-title">消息</h5>
								<!-- <button type="button" class="btn blue" onclick="opendetil();">代办明细</button> -->
							</div>
							<div class="widget-body" style="height: 350px;">
								<div class="widget-main">
									<div class="tabbable">
										<ul class="nav nav-tabs padding-12 " id="mymesgeTab">
											<li class="active"><a data-toggle="tab"
												href="#mesgeTab1"> <span id="mesge_all">未阅</span></a></li>
											<li><a data-toggle="tab" href="#mesgeTab2"> <span
													id="hasmesge_all">已阅</span></a></li>
										</ul>
										<div class="tab-content">
											<div id="mesgeTab1" class="tab-pane in active">
												<table id="mesgtable1"
													class="table table-striped table-bordered table-hover novertical">
													<thead>
														<tr>
											...
											<div id="mesgeTab2" class="tab-pane">
												<table id="mesgtable2"
													class="table table-striped table-bordered table-hover novertical">
													<thead>
														<tr>
												...
												<div class="widget-box dia-widget-box">
													<div class="widget-body">
														<div class="widget-main">
															...
															<div class="add-item">
																<p id="mesagetype" class="form-control no-border"
																	style="height: 150px;"></p>
															</div>
															<div class="add-item-btn" id="messageviewBtn"
	...
	<script type="text/javascript">
		...
		function init() {
			...
			var myTable = $('#detailtable').DataTable({
								...
								columns : [ {data : "itemName","width" : "40%"}, 
								            {data : "insertTime","width" : "40%"}, 
								            {data : "insertUserName","width" : "20%"} ],
								columnDefs : [{
											targets : 0,
											render : function(data, type, row,meta) {
												return '<a onclick="opendetil('+ row.itemId+ ','+ row.processDetailId+ ','+ row.id+ ')"><p class="editlink">'+ data + '</p></a>';
											}
										},{
											//入职时间
											targets : 1,
		...
		/**工作台已办事项**/
		function hasdoinit() {
			var myTable = $('#hasdotable').DataTable({
								dom : 'Bfrtip',
								"bLengthChange" : false,//屏蔽tables的一页展示多少条记录的下拉列表
								"bFilter" : false, //不使用过滤功能  
								"bProcessing" : true, //加载数据时显示正在加载信息
								...
								columns : [ {data : "itemName","width" : "80%"}, 
								            {data : "operateTime","width" : "127px;"}] ,										
								columnDefs : [{
											targets : 0,
											render : function(data, type, row,meta) {
												return '<a onclick="openhasdodetil('+ row.itemId+ ','+ row.processDetailId+ ','+ row.id+ ')"><p class="editlinkes">'+ data + '</p></a>';
											}
										},
										{
											//入职时间
								...
								"fnServerData" : hasretrieveData
							//与后台交互获取数据的处理函数
							});
		}
		/***我的备忘***/
		function reminderinit() {
			var myTable = $('#remindertable').DataTable({
								dom : 'Bfrtip',
								//"sDom": 'rt',
								"bLengthChange" : false,//屏蔽tables的一页展示多少条记录的下拉列表
								"bFilter" : false, //不使用过滤功能  
								...
								columns : [ {data : "mark","width" : "70%"}, 
								            {data : "updateTime","width" : "30%"}]  ,
								columnDefs : [{
											targets : 0,
											render : function(data, type, row,meta) {
												return '<a onclick="doeditreminder('+ row.id+ ')"><p class="editlink">'+ data + '</p></a>';
											}
										},
										{
											//入职时间
								...
								"fnServerData" : remretrieveData
							//与后台交互获取数据的处理函数
							});
		}
		/****消息-未阅******/
		function mesginit1() {
			var myTable = $('#mesgtable1').DataTable({
								dom : 'Bfrtip',
								//"sDom": 'rt',
								"bLengthChange" : false,//屏蔽tables的一页展示多少条记录的下拉列表
								"bFilter" : false, //不使用过滤功能  
								...
								columnDefs : [{
											targets : 0,
											render : function(data, type, row, meta) {
												return '<a onclick="doviewneredmesg('+ row.id+ ')"><p class="editlinks">'+ data + '</p></a>';
											}
										},
										{
											//入职时间
								...
								"fnServerData" : mesgnoredretrieveData
							//与后台交互获取数据的处理函数
							});
		}
		/****消息-已阅******/
		function mesginit2() {
			var myTable = $('#mesgtable2').DataTable({
								dom : 'Bfrtip',
								//"sDom": 'rt',
								"bLengthChange" : false,//屏蔽tables的一页展示多少条记录的下拉列表
								"bFilter" : false, //不使用过滤功能  
								...
								columns : [ {data : "mark","width" : "60%"}, 
								            {data : "insertTime","width" : "197px;"} ] ,
								columnDefs : [{
											targets : 0,
											render : function(data, type, row,meta) {
												return '<a onclick="doviewmesg('+ row.id+ ')"><p class="editlinks">'+ data + '</p></a>';
											}
										},
										{
											//入职时间
		...
		/**工作台已办事项**/
		function hasdoroload() {
			//$("#detailtable tbody tr").remove(); 
			var table = $('#hasdotable').DataTable({
								"destroy" : true,//如果需要重新加载需销毁
								dom : 'Bfrtip',
								"bLengthChange" : false,//屏蔽tables的一页展示多少条记录的下拉列表
								"bFilter" : false, //不使用过滤功能  
						...
						success : function(data) {
							if (data && data.code == 200) {
								...
								if (obj.aaData.length > 0) {
									...
									$('#waitingDo_all').html('待办（' + totalCounts + '）');
								} else {
									obj.aaData = [];
								}
		...
		function hasretrieveData(sSource, aoData, fnCallback) {
			var secho = aoData[0]["value"];
			var pageStartIndex = aoData[3]["value"];
			var pageSize = aoData[4]["value"];
			$('#secho').val(secho);
		...
		function mesgnoredretrieveData(sSource, aoData, fnCallback) {
			var secho = aoData[0]["value"];
			var pageStartIndex = aoData[3]["value"];
			var pageSize = aoData[4]["value"];
			$('#secho').val(secho);
		...
		function mesgretrieveData(sSource, aoData, fnCallback) {
			var secho = aoData[0]["value"];
			var pageStartIndex = aoData[3]["value"];
			var pageSize = aoData[4]["value"];
			$('#secho').val(secho);
				...
				success : function(data) {
					if (data && data.code == 200) {
						...
						if (obj.aaData.length > 0) {
							...
							var totalCounts = data.data.totalCounts;
							$('#hasmesge_all').html('已阅（' + totalCounts + '）');
						} else {
							obj.aaData = [];
						}
						fnCallback(obj); //服务器端返回的对象的returnObject部分是要求的格式  	
		...
		//待办事项明细页面
		function opendetil(itemId, processDetailId, taskId) {
			console.log(1);
			//clearaudit();
			getStockList();
			/* 根据货运车绑定驾驶员 */
			$('#newcarNumber_audit').on('change',function(e) {
			var newDriver = $(this).find('option:selected').attr('data-driverName');
			$('#newdriver_audit').val(newDriver);
			$('#newdriver_audit_id').val($(this).find('option:selected').attr('data-driverId'));
			});
			$('#hidden2').show();
							...
							if (data && data.code == 200) {
								...
								if (data.data.businessType == '01') {
									...
									if (data.data.detail.sendTime != null&& data.data.detail.sendTime != '') {
										$("#sendTime_audit").html(data.data.detail.sendTime.substr(0, 19));
									}
									...
									$("#targetAddress_audit").html(data.data.detail.targetCity);
									$("#targetProvince_audit").html(data.data.detail.targetProvince);
									...
									//location.href="${ctx}/dailyOffice/waitingDo/detail?"+itemId+"&"+processDetailId+"&"+taskId;
									...
									$("#oldDriver_changeCar").html(data.data.detail.oldDriverName);
									$("#newCarNumber_changeCar").html(data.data.detail.newCarNumber);
									$("#newDriver_changeCar").html(data.data.detail.newDriverName);
									...
									$("#driver_port").html(data.data.detail.driverName);
									...
									//console.info(JSON.stringify(data.data.detail.detailList));
								...
								$.ajax({
											...
											success : function(data) {
												if (data && data.code == 200) {
													...
													$("#name_mesg").html(name);
													if((businessType=='14'||businessType=='15')&&status=='0'){
														$('#hidden2').hide();
														$('#hidden3').hide();
														$('#hidden8').hide();
														$('#auditBtn').hide();
														...
														/* $('#msglblereview').hide(); */
														$('#stephidden').hide();
													}else if (data.data.orderNo == '0' &&businessType!='14'&&businessType!='15') {
														$('#hidden2').hide();
														$('#hidden3').hide();
														$('#hidden7').hide();
														$('#hidden8').hide();
													...
													/* if(businessType=='05'&&data.data.orderNo=='2'){
														//$('#hiddenpre').show();
														$('#hidden2').hide();
														$('#hidden3').hide();
														$('#hidden6').hide();
													...
													/* if (businessType == '11'&& data.data.type == '0') {
														$('#hiddeffice').show();
														$("#speds_audit").removeAttr("style");
														//$('#speds_audit').attr('display','block');
														//console.info($('#amount_damgcost').html());
														var cashAdvance = $('#amount_damgcost').html();
														$('#cashAdvance_audit').val(cashAdvance);
													} */
												} else {
													bootbox.alert(data.msg);
												}
														...
														columnDefs : [
																...
																},
																{
																	...
																	render : function(
																		...
																		if (data != ''
																				&& data != null) {
																			var attachFilePaths = "${ctx}"
																					+ row.attachFilePath;
																			return '<a  href='+attachFilePaths+' target="_blank">'
																					+ data
																					+ '</a>';
																		} else {
																			return '';
		...
		function getdetil() {
			...
			$
					.ajax({
						type : 'GET',
						url : "${ctx}/waybill/waybillManage/checkWaybill/"
								+ waybillid,
						contentType : "application/json;charset=UTF-8",
						dataType : 'JSON',
						success : function(data) {
							if (data && data.code == 200) {
								...
								$("#carShopId_view")
										.html(data.data.carShopName);
								$("#sendTime_view").html(data.data.sendTime);
								$("#receiveUser_view").html(
										data.data.receiveUser);
								$("#receiveUserTelephone_view").html(
										data.data.receiveUserTelephone);
								$("#receiveUserMobile_view").html(
										data.data.receiveUserMobile);
								$("#startAddress_view").html(
										data.data.startAddress);
								$("#targetAddress_view").html(
										data.data.targetCity);
								$("#targetProvince_view").html(
										data.data.targetProvince);
								$("#distance_view").html(data.data.distance);
								if (data.data.attachFileName != ''
										&& data.data.attachFileName != null) {
									var attachFilePathes = "${ctx}"
											+ data.data.attachFilePath;
									$("#file_view").html(
											'<a  href='+attachFilePathes+' target="_blank">'
													+ data.data.attachFileName
													+ '</a>');
								}
		...
		function clearaudit() {
			$("#waybillNo_audit").html('');
			$("#supplierId_audit").html('');
			$("#amount_audit").html('');
			$("#brand_audit").html('');
			$("#carShopId_audit").html('');
			$("#sendTime_audit").html('');
			$("#receiveUser_audit").html('');
			$("#receiveUserTelephone_audit").html('');
			$("#receiveUserMobile_audit").html('');
			$("#startAddress_audit").html('');
			$("#targetAddress_audit").html('');
			$("#distance_audit").html('');
			$("#taskHistory_view tbody tr").remove();
		}
		function waybillaudit(successFlag) {
			...
			//console.info("balanceCash"+balanceCash);
			if (discountFlag=='Y' && balanceCash!= ''&& balanceCashNextMonth!= '') {
				balanceCash=parseFloat(balanceCash)+parseFloat(balanceCashNextMonth);
			}
			if(discountFlag!='Y'){
				balanceCashNextMonth=0;
			}
			//console.info("balanceCash"+balanceCash);
			//console.info("balanceCashNextMonth"+balanceCashNextMonth);
			//$("#test").is(":hidden");//是否隐藏balanceCash
			/*  if(businessType=='03'&&newCarNumber!=''){
				 bootbox.alert('新货车已选择不可重复选！');
				 return;
			}  */
			//console.info(needSuggestFlag);
			if (audit_mesg == '' && needSuggestFlag != 'N') {
		...
		function refresh() {
			...
			//table.fnClearTable(); 
			//init();
			//table.ajax.url("${ctx}/dailyOffice/waitingDo/getListData").load(); 
			/* $('#detailtable').dataTable().fnDestroy(); */
			/* roload(); */
		...
		function openhasdodetil(itemId, processDetailId, taskId) {
			$('#taskId-hidden').val(taskId);
			$('#hidden7').hide();
			$('#stephidden').hide();
			$('#hidden2').hide();
						...
						success : function(data) {
							if (data && data.code == 200) {
								...
								if (data.data.businessType == '01') {
									...
									$('#waybillNo-hidden').val(
											data.data.detail.waybillNo);
									$("#waybillNo_audit").html(
											data.data.detail.waybillNo);
									$("#supplierId_audit").html(
											data.data.detail.supplierName);
									$("#amount_audit").html(
											data.data.detail.amount);
									$("#brand_audit").html(
											data.data.detail.brand);
									$("#carShopId_audit").html(
											data.data.detail.carShopName);
									$("#sendTime_audit").html(
											data.data.detail.sendTime);
									$("#receiveUser_audit").html(
											data.data.detail.receiveUser);
									$("#receiveUserTelephone_audit").html(data.data.detail.receiveUserTelephone);
									$("#receiveUserMobile_audit").html(data.data.detail.receiveUserMobile);
									$("#startAddress_audit").html(data.data.detail.startAddress);
									$("#targetAddress_audit").html(data.data.detail.targetCity);
									...
									$('#scheduleBillNo-hidden').val(
											data.data.detail.scheduleBillNo);
									//$('#changecarId-hidden').val(data.data.detail.id);
									$("#scheduleBillNo_changeCar").html(
											data.data.detail.scheduleBillNo);
									$("#oldCarNumber_changeCar").html(
											data.data.detail.oldCarNumber);
									$("#oldDriver_changeCar").html(
											data.data.detail.oldDriverName);
									$("#newCarNumber_changeCar").html(
											data.data.detail.newCarNumber);
									$("#newDriver_changeCar").html(
											data.data.detail.newDriverName);
									$("#reason_changeCar").html(
											data.data.detail.reason);
									if (data.data.detail.id != '') {
										$('#changecarId-hidden').val(
												data.data.detail.id);
									}
									...
									$('#prepay_detilbtn').hide();
									$('#modal-detilinfo').modal('show');
									$("#prepayCarNumber_audit").html(
											data.data.detail.carNumber);
									$("#applyTime_audit").html(
											data.data.detail.applyTime);
									$("#prepaydriver_audit").html(
											data.data.detail.driverName);
									$("#prepaymobile_audit").html(
											data.data.detail.mobile);
									$("#prepayCash_audit").html(
											data.data.detail.prepayCash);
									$("#bankName_audit").html(data.data.detail.bankName);
									$("#bankAccount_audit").html(
											data.data.detail.bankAccount);
									$("#oilCardNo_audit").html(
											data.data.detail.oilCardNo);
									$("#oilAmount_audit").html(
											data.data.detail.oilAmount);
									$("#prepaymark_audit").html(
											data.data.detail.mark);
									if (data.data.detail.id != '') {
										$('#tranPrepayId-hidden').val(
												data.data.detail.id);
									}
									...
									//$('#changecarId-hidden').val(data.data.detail.id);
									//$("#scheduleBillNo_changeCar").html(data.data.detail.scheduleBillNo); 
									$("#tyreInOutno_audit").html(
											data.data.detail.billNo);
									var type = data.data.detail.type;
									var typename = "";
									if (type == '0') {
										typename = '入库'
									...
									$("#tyreInOuttype_audit").html(typename);
									$("#tyreInOutmark_audit").html(
											data.data.detail.mark);
									if (data.data.detail.id != '') {
										$('#tyreInOutId-hidden').val(
												data.data.detail.id);
									}
									if (data.data.detail.detailList.length > 0) {
										for (var i = 0; i < data.data.detail.detailList.length; i++) {
									...
									$('#modal-detilinfo').modal('show');
									$("#process_off").html(
											data.data.item.processName);
									$("#itemName_off").html(
											data.data.item.itemName);
									$("#amount_off")
											.html(data.data.item.amount);
									$("#cashAdvance_off").html(
											data.data.item.cashAdvance);
									$("#startTime_off").html(
											data.data.item.startTime);
									$("#endTime_off").html(
											data.data.item.endTime);
									$("#mark_maint").html(data.data.item.mark);
								} else if (data.data.businessType == '09') {
									//console.log(JSON.stringify(data.data.businessType));
									$('#waybill_msg').hide();
									...
									$("#applyTime_chge")
											.html(
													jsonDateFormat(data.data.detail.applyTime));
									$("#oldNo_chge").html(
											data.data.detail.oldTyreNo);
									$("#newNo_chge").html(
											data.data.detail.newTyreNo);
									$("#mark_chge").html(data.data.detail.mark);
									if (data.data.detail.oldTyrePic != null
											&& data.data.detail.oldTyrePic != ''
											&& data.data.detail.oldTyrePic != undefined) {
										var html = '<a  href=${ctx}'+data.data.detail.oldTyrePic+' target="_blank">原轮胎图片</a>';
										$('#oldfilename-view').html(html);
									}
									if (data.data.detail.newTyrePic != null
											&& data.data.detail.newTyrePic != ''
											&& data.data.detail.newTyrePic != undefined) {
										var html2 = '<a  href=${ctx}'+data.data.detail.newTyrePic+' target="_blank">新轮胎图片</a>';
										$('#newfilename-view').html(html2);
									}
									...
									$('#damgcostId-hidden').val(
											data.data.detail.id);
									$("#scheduleno_damgcost").html(
											data.data.detail.scheduleBillNo);
									$("#bankName_damgcost").html(
											data.data.detail.bankName);
									$("#accountName_damgcost").html(
											data.data.detail.accountName);
									$("#accountNo_damgcost").html(
											data.data.detail.accountNo);
									$("#amount_damgcost").html(
											data.data.detail.amount);
									if (data.data.detail.insuranceFlag == 'Y') {
										$('#insuranceFlag_damgcost').html('是');
									} else {
									...
									$("#mark_damgcost").html(
											data.data.detail.mark);
									if (data.data.detail.attachFilePath != ''
											&& data.data.detail.attachFilePath != null) {
										var attachFilePaths = data.data.detail.attachFilePath
												.split(';');
										var html = '';
										for (var i = 0; i < attachFilePaths.length; i++) {
											var attachFilePathes = "${ctx}"
													+ attachFilePaths[i];
											var j = i + 1;
											html += '<a  href='+attachFilePathes+' target="_blank">照片'
													+ j + '</a>&nbsp;&nbsp;';
										}
										$("#file_damgcost").html(html);
									}
									...
									$('#damgcost_detilbtn').hide();
									$('#modal-detilinfo').modal('show');
									if (data.data.detail.insertTime != ''
											&& data.data.detail.insertTime != null) {
										$('#insertTime_dagout')
												.html(
														jsonDateFormat(data.data.detail.insertTime));
									} else {
										$('#insertTime_dagout').html('');
									}
									$("#mark_dagout").html(
											data.data.detail.mark);
									$("#cardagoutid_hidden").val(
											data.data.detail.id);
									//console.log(data.data.detail.id);
									var id = data.data.detail.id;
									$.ajax({
							...
							if (data && data.code == 200) {
								...
								if (data.data['preList'] != null&& data.data['preList'].length > 0) {
									for (var k = 0; k < data.data['preList'].length; k++) {
										...
										prepayHtml += '<div class="border-b-ff9a00"><div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>预付现金:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="prepayCash'+k+'" class="form-control no-border">'
												+ prepayCash
												+ '</p></div></div>'
												+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>开户行:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="bankName'+k+'" class="form-control no-border">'
												+ bankName
												+ '</p></div></div></div>'
												+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>账号:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="bankAccount'+k+'" class="form-control no-border">'
												+ bankAccount
												+ '</p></div></div>'
												+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>预付油卡卡号:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="oilCardNo'+k+'" class="form-control no-border">'
												+ oilCardNo
												+ '</p></div></div></div>'
												+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>预付油费:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="oilAmount'+k+'" class="form-control no-border">'
												+ oilAmount
												+ '</p></div></div>'
												+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>预付状态:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p id="prepayStatus'+k+'" class="form-control no-border">'
												+ status
												+ '</p></div></div></div></div>';
									}
								} else {
								...
								if (data.data['detailList'].length > 0) {
									...
									for (var i = 0; i < data.data['detailList'].length; i++) {
										...
										if (carInfo != null
											...
											for (var j = 0; j<carInfo.length>0; j++) {
												...
												if (carShopName != null && carShopName != "") {
													if(carInfo[j]['color']==null){
														carInfo[j]['color']='';
													}
													if(carInfo[j]['vin']==null){
														carInfo[j]['vin']='';
													}
													if(carInfo[j]['model']==null){
														carInfo[j]['model']='';
													}
													if(carInfo[j]['waybillNo']==null){
														carInfo[j]['waybillNo']='';
													}
													if(carInfo[j]['brand']==null){
														carInfo[j]['brand']='';
													}
													carHtmlItem += '<tr><td>'
															+ carInfo[j]['vin']
															...
															+ carInfo[j]['color']
															+ '</td><td>'
															+ jsonDateFormat(carInfo[j]['insertTime'])
															+ '</td>'
															+ '<td>'
															+ carInfo[j]['waybillNo']
															+ '</td><td>'
										...
										/* 配件信息 */
										if (carAttachmentInfo != null
												&& carAttachmentInfo.length > 0) {
											for (var k = 0; k<carAttachmentInfo.length>0; k++) {
												carAttachmentHtmlItem += '<tr><td>'
														+ carAttachmentInfo[k]['attachmentName']
														+ '</td>'
														+ '<td>'
														+ carAttachmentInfo[k]['position']
														+ '</td>'
														+ '<td>'
														+ carAttachmentInfo[k]['count']
														+ '</td>'
														+ '<td>'
														+ carAttachmentInfo[k]['outCount']
														+ '</td></tr>';
										...
										if (data.data['detailList'][i]['carShopId'] != null && data.data['detailList'][i]['carShopId'] != '') {
											detailListHtml += '<div class="border-b-ff9a00 detailList" id="detailList'+i+'">'
													...
													+ '<div class="col-xs-3"><div class="form-contr"><p class="carShopId-item form-control">'
													+ data.data['detailList'][i]['carShopName']
													+ '</p></div></div>'
													+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>数量:</label></div></div>'
													+ '<div class="col-xs-3"><div class="form-contr"><p class="amount-item form-control">'
													+ data.data['detailList'][i]['amount']
													+ '</p></div></div>'
													+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>详细指令:</label></div></div>'
													+ '<div class="col-xs-3"><div class="form-contr"><p class="detailMark-item form-control">'
													+ data.data['detailList'][i]['mark']
													+ '</p></div></div></div>'
													+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>始发地:</label></div></div>'
													+ '<div class="col-xs-3"><div class="form-contr"><p class="form-control no-border">'
													+ startAddress
													+ '</p></div></div>'
													...
													+ '<div class="col-xs-11"><div class="newCarDetail-item">'
													+ carHtml
													+ '</div></div></div>'
													+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>配件信息:</label></div></div>'
													+ '<div class="col-xs-11"><div class="newPartDetail-item">'
													+ carAttachmentHtml
													+ '</div></div></div></div>';
										} else {
											detailListHtml += '<div class="border-b-ff9a00 detailList" id="detailList'+i+'">'
													...
													+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>数量:</label></div></div>'
													+ '<div class="col-xs-2"><div class="form-contr"><p class="amount-item form-control">'
													+ data.data['detailList'][i]['amount']
													+ '</p></div></div>'
													+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label>详细指令:</label></div></div>'
													+ '<div class="col-xs-3"><div class="form-contr"><p class="detailMark-item form-control">'
	...
	var url="${ctx}/operationMng/scheduleMng/fastDetailIndex/"+scheduleBillNo+"/"+flag;
			...
			bootbox.confirm({
				...
				callback : function(result) {
					if (result) {
						$.ajax({
							type : 'GET',
							url : "${ctx}/dailyOffice/officeReminder/delete/"+ reminderid,
							contentType : "application/json;charset=UTF-8",
							dataType : 'JSON',
							success : function(data) {
								if (data && data.code == 200) {
								...
								if (data.data != null && data.data != '') {
									if (data.data.length > 0) {
										for (var i = 0; i < data.data.length; i++) {
											html += '<option value='+data.data[i]['no']+' data-driverId='+data.data[i]['driverId']+' data-driverName='+data.data[i]['driverName']+'>'
													+ data.data[i]['no']
													+ '</option>';
										}
									}
		...
		function getportCostdetils() {
			...
			var detailItem = "";
			var prepayHtml="";
			// parent.addTabs({id:'499',title: '装运费用审核明细',close: true,url: '${ctx}/operationMng/transportCostMng/queryIndex/'+id+"/2"});
								...
								if (data.data['detailList'].length > 0) {
									for (var i = 0; i < data.data['detailList'].length; i++) {
										...
										detailListHtml += '<div id="detailList'+i+'" class="border-b-ff9a00 detailList">'
												...
												+ '<div class="col-xs-5"><div class="form-contr"><p class="form-control form-control-item" id="brandName'+i+'">'
												+ data.data['detailList'][i]['brandName']
												+ '</p></div></div>'
												+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label><span class="red">*</span>台数:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p class="form-control form-control-item" id="count'+i+'">'
												+ data.data['detailList'][i]['count']
												+ '</p></div></div></div>'
												+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label><span class="red">*</span>起运地:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p class="form-control form-control-item" id="startAddress'+i+'">'
												+ data.data['detailList'][i]['startAddress']
												+ '</p></div></div>'
												+ '<div class="col-xs-1 pd-2"><div class="lab-tit"><label><span class="red">*</span>目的地:</label></div></div>'
												+ '<div class="col-xs-5"><div class="form-contr"><p class="form-control form-control-item" id="endAddress'+i+'">'
												+ data.data['detailList'][i]['endAddress']
												+ '</p></div></div></div>'
												+ '<div class="row newrow"><div class="col-xs-1 pd-2"><div class="lab-tit"><label>备注:</label></div></div>'
												+ '<div class="col-xs-11"><div class="form-contr"><p class="form-control form-control-item" id="remark'+i+'">'
												+ data.data['detailList'][i]['mark']
												+ '</p></div></div></div></div>';
									}
			...
			if (money != null && money != '') {
				if (!reg.test(money)) {
					if (flag == '0') {//预付现金    			
						...
						$('#balanceCashNextMonth_audit').val('');
						bootbox.alert('请输入正确的金额！');
					}
				} else {
					//console.info(money);
		...
		function getdamgcostdetil() {
			...
			$
					.ajax({
						type : 'GET',
						url : "${ctx}/operationMng/carDamageCostMng/getDetail/"
								+ id,
						data : {},
						dataType : 'JSON',
						success : function(data) {
								...
								if (data.data.detailList != null
									...
									for (var i = 0; i < objs.length; i++) {
										html += '<tr>' + '<td>'
												...
												+ carlist[i]["engineNo"]
												+ '</td>' + '<td>'
												+ carlist[i]["carShopName"]
												+ '</td>' + '<td>'
												+ objs[i]["amount"] + '</td>'
												+ '</tr>';
									}
								}
								if (data.data.attachFilePath != null
										&& data.data.attachFilePath != '') {
									path = data.data.attachFilePath
									pathlist = path.substring(0,
											path.length - 1);
									arr = pathlist.split(';');
									if (arr != null && arr != ""
											&& arr.length > 0) {
										for (var k = 0; k < arr.length; k++) {
											var attachFilePaths = "${ctx}"
													+ arr[k];
											pathHtml += '<p><a href='+attachFilePaths+' target="_blank">照片'
													+ (k + 1) + '</a></p>';
										}
									}
								}
		...
		/***驾驶员费用审核的待审信息***/
		function newpagereview() {
			var id = $('#tranPortCostId-hidden').val();
			parent.addTabs({
				id : '8888',
				title : '驾驶员费用审核',
				close : true,
				url : '${ctx}/operationMng/transportCostMng/reviewIndex/' + id
			});
		}
