...
_aa6(this,q);                             //ww  清空按钮
}},currentText:"Today",closeText:"Close",cleanText:"Clean",okText:"Ok",buttons:[{text:function(_abb){
...
{text:function(_abff){return $(_abff).datebox("options").cleanText;},
handler:function(_abg){$(_abg).combo('setValue','').combo('setText','')//清空值
$(this).closest("div.combo-panel").panel("close");//关闭面板
}}],formatter:function(date){
