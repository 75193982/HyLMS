	...
	<div class="page-content">
		...
		<table id="detailtable" class="table table-striped table-bordered table-hover">
				...
				<div class="modal-dialog dia-widget-box" style="padding:0;width:100%;">
				  <div class="modal-content">
				     <div class="modal-header" style="padding:0 15px;">
						...
						<h3 id="myModalLabel">折损维修登记申请</h3>
				    </div>
							...
							<div class="widget-body">
								<div class="widget-main">
								   <div class="add-item extra-itemSec">
								     ...
								     <select id="carStockInfo" class="form-control">
								     ...
								     <label class="title"><span class="red">*</span>登记人：</label>
								      <input class="form-control" id="applyUser" type="text" placeholder="登记人" disabled="disabled"/>
								    </div>
							  		<hr class="tree"></hr>
								     <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>登记时间：</label>
									     <div class="input-group input-group-sm" style="width:75%">
											<input class="form-control" id="applyTime" type="text" placeholder="请输入登记时间" />
										     <span class="input-group-addon">
											    <i class="icon-calendar"></i>
										     </span>
										</div>
								    ...
								    <div class="add-item extra-itemSec">
								        <label class="title"><span class="red">*</span>预计修好时间：</label>
									     <div class="input-group input-group-sm" style="width:75%">
												<input class="form-control" id="repairFinishedTime" type="text" placeholder="预计修好时间" />
											     <span class="input-group-addon">
													<i class="icon-calendar"></i>
												 </span>
										  </div>
								     ...
								     <div class="add-item extra-itemSec">
									     ...
									     <input class="form-control" id="repairContent" type="text" placeholder="请输入维修项目" />
									 </div>
								    <hr class="tree"></hr>
								    <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>维修厂：</label>
									     <input class="form-control" id="repairCompany" type="text" placeholder="请输入维修厂" />
									 </div>
								    <hr class="tree"></hr>
								    <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>维修电话：</label>
									     <input class="form-control" id="repairTelephone" type="text" placeholder="请输入维修电话" />
									 </div>
								    <hr class="tree"></hr>
			...
			<div class="modal fade modal-reset" id="modal-edit" tabindex="-1" role="dialog" data-backdrop="static">
				<div class="modal-dialog dia-widget-box" style="padding:0;width:100%;">
				  <div class="modal-content">
				     <div class="modal-header" style="padding:0 15px;">
						...
						<h3 id="myModalLabel">编辑折损维修登记申请</h3>
				    </div>
					<div class="modal-body">
					    <div class="widget-box dia-widget-box">
							<div class="widget-body">
								<div class="widget-main">
								   <div class="add-item extra-itemSec">
								     <label class="title"><span class="red">*</span>折损车架号：</label>
								     <select id="ecarStockInfo" class="form-control">
							  		...
							  		<div class="add-item extra-itemSec">
								     <label class="title"><span class="red">*</span>登记人：</label>
								      <input class="form-control" id="eapplyUser" type="text" placeholder="登记人" disabled="disabled"/>
								    </div>
							  		<hr class="tree"></hr>
								     <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>登记时间：</label>
									     <div class="input-group input-group-sm" style="width:75%">
											<input class="form-control" id="eapplyTime" type="text" placeholder="请输入登记时间" />
										     <span class="input-group-addon">
											    <i class="icon-calendar"></i>
										     </span>
										</div>
								    ...
								    <div class="add-item extra-itemSec">
								         <label class="title"><span class="red">*</span>预计修好时间：</label>
									     <div class="input-group input-group-sm" style="width:75%">
												<input class="form-control" id="erepairFinishedTime" type="text" placeholder="预计修好时间" />
											     <span class="input-group-addon">
													<i class="icon-calendar"></i>
												 </span>
										  </div>
								     ...
								     <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>维修项目：</label>
									     <input class="form-control" id="erepairContent" type="text" placeholder="请输入维修项目" />
									 </div>
								    <hr class="tree"></hr>
								    <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>维修厂：</label>
									     <input class="form-control" id="erepairCompany" type="text" placeholder="请输入维修厂" />
									 </div>
								    <hr class="tree"></hr>
								    <div class="add-item extra-itemSec">
									     <label class="title"><span class="red">*</span>维修电话：</label>
									     <input class="form-control" id="erepairTelephone" type="text" placeholder="请输入维修电话" />
									 </div>
								    <hr class="tree"></hr>
			 ...
			 <!-- 完成确认 -->
			 <div class="modal fade" id="modal-info" tabindex="-1" role="dialog" style="height:300px;">
				<div class="modal-header">
					<button class="close" type="button" data-dismiss="modal" onclick="finishrefresh();">×</button>
					<h3 id="myfinishLabel">确认折损维修登记</h3>
				</div>
				<div class="modal-body">
				   <div>
					  <div class="widget-box dia-widget-box">
							<div class="widget-body">
								<div class="widget-main">
								  <div class="add-item extra-itemSec">
								    <label class="title" ><span class="red">*</span>取车时间 ：</label>	
								       <div class="input-group input-group-sm" style="width:75%">
												<input class="form-control" id="cfinishTime" type="text" placeholder="取车时间" />
											     <span class="input-group-addon">
													<i class="icon-calendar"></i>
												 </span>
										 </div>							    
								 ...
								 <div class="add-item extra-itemSec">
								    <label class="title" ><span class="red">*</span>取车人 ：</label>	
								      <input class="form-control" id="cfinishUser" type="text" placeholder="请输入取车人  " />
								      <input class="form-control" id="detilid-hidden" type="hidden"/>						    
								  </div>						  
								  <hr class="tree"></hr>
							      <div class="add-item-btn dis-block" id="addBtn" style="display:block">
...
function init(){
	...
	var myTable = $('#detailtable').DataTable({
		 ...
		 "sAjaxSource": "${ctx}/operationMng/trackRepairApply/getListData" , //获取数据的ajax方法的URL							 
		 "ordering": false,	
			"oLanguage": {
			    		 ...
			    		 if(row.status=='0'){
			    			  return '<a class="table-edit" onclick="doedit('+ row.id +')">编辑</a>'
		                    	...
		                    	return '<a class="table-edit" onclick="doshow('+ row.id +')">查看</a>'
		                    	      +'<a class="table-edit" onclick="doconfirm('+ row.id +')" style="width:60px;">完成确认</a>';
		                    }else{
		                    	return '<a class="table-edit" onclick="doshow('+ row.id +')">查看</a>';
		                    }
...
$(function(){
	...
	$("#repairFinishedTime").datetimepicker({
		language: 'cn',
	      format: "yyyy-mm-dd hh:ii",
	      autoclose: true,//选中之后自动隐藏日期选择框
	      todayBtn: true
	});
	$("#eapplyTime").datetimepicker({
	      language: 'cn',
	      format: "yyyy-mm-dd hh:ii",
	      autoclose: true,
	      todayBtn: true
	   });
	$("#erepairFinishedTime").datetimepicker({
		language: 'cn',
	      format: "yyyy-mm-dd hh:ii",
	      autoclose: true,//选中之后自动隐藏日期选择框
	      todayBtn: true
	});
	$("#cfinishTime").datetimepicker({
		language: 'cn',
	      format: "yyyy-mm-dd hh:ii",
	      autoclose: true,//选中之后自动隐藏日期选择框
	      todayBtn: true
...
/* 获取折损车号 */
function getDamageStocks(){
	  $.ajax({  
	        url: '${ctx}/operationMng/trackRepairApply/getDamageStocks',  
	        type: "GET",  
	        contentType : "application/json;charset=UTF-8",  
			dataType : 'JSON',
	        data: '',
	        success: function (data) {
	        	var html ='<option value="">请选择折损车架号</option>';
	            if(data.code == 200){  
	            	if(data.data!=null && data.data!=''){
	            		if(data.data.length>0){
	            			for(var i=0;i<data.data.length;i++){
	                			html +='<option value='+data.data[i]['id']+'>'+data.data[i]['vin']+'</option>';
	                		}
	            		}
	            	}
	            	$('#carStockInfo').html(html);
	            	$('#ecarStockInfo').html(html);
	               }else{  
	            	   bootbox.alert('加载失败！');
	               }  
	        }  
...
function dodelete(id){
	...
	bootbox.confirm({ 
		  size: "small",
		  message: "确定要删除该折损维修登记信息?", 
		  callback: function(result){
			  if(result){
				  $.ajax({
						type : 'GET',
						url : "${ctx}/operationMng/trackRepairApply/delete/"+ids,
						data :{},
						dataType : 'JSON',
						success : function(data) {
							if (data && data.code == 200) {
...
function dosumbit(id){
	...
	bootbox.confirm({ 
		  size: "small",
		  message: "确定要提交该折损维修登记信息?", 
		  callback: function(result){
			  if(result){
				  $.ajax({
						type : 'GET',
						url : "${ctx}/operationMng/trackRepairApply/submit/"+ids,
						data :{},
						dataType : 'JSON',
						success : function(data) {
							if (data && data.code == 200) {
...
function clear(){
	$('#carStockInfo').val('');
	$('#applyUser').val('${sessionScope.LMS_USER.name}');
	$('#applyTime').val('');
	$('#repairContent').val('');
	$('#repairCompany').val('');
	$('#repairTelephone').val('');
	$('#repairFinishedTime').val('');
}
/* 查看申请详细信息 */
function doshow(id){
	var ids=parseInt(id);
	...
	$.ajax({
		...
		success : function(data) {
			if (data && data.code == 200) {
				...
				$('#ecarStockInfo').val(data.data.carStockId);
				$('#eapplyUser').val(data.data.name);
				$('#eapplyTime').val(applyTime);
				$('#erepairContent').val(data.data.repairContent);
				$('#erepairCompany').val(data.data.repairCompany);
				$('#erepairTelephone').val(data.data.repairTelephone);
				$('#erepairFinishedTime').val(repairFinishedTime);
...
function save(){
	 var flag="false";
	 var objList={};
     var carStockId=$('#carStockInfo').val();
     var applyUser='${sessionScope.LMS_USER.name}';
     var applyTime=$('#applyTime').val();
     var repairContent=$('#repairContent').val();
     var repairCompany=$('#repairCompany').val();
     var repairTelephone=$('#repairTelephone').val();
     var repairFinishedTime=$('#repairFinishedTime').val();
	 if($('#carStockInfo').val()=='' || $('#carStockInfo').val()==null){
		 bootbox.alert('请选择折损车架号！');
		 return;
	 }
	 if($('#applyTime').val()=='' || $('#applyTime').val()==null){
		 bootbox.alert('请输入登记时间！');
		 return;
	 }
	 if($('#repairContent').val()=='' || $('#repairContent').val()==null){
		 bootbox.alert('请输入维修项目！');
		 return;
	 }
	 if($('#repairCompany').val()=='' || $('#repairCompany').val()==null){
		 bootbox.alert('请输入维修厂信息！');
		 return;
	 }
	 if($('#repairTelephone').val()=='' || $('#repairTelephone').val()==null){
		 bootbox.alert('请输入维修电话！');
		 return;
	 }
	 if($('#repairFinishedTime').val()=='' || $('#repairFinishedTime').val()==null){
		 bootbox.alert('请输入预计修好时间！');
		 return;
	 }
	 objList.carStockId=carStockId;
	 objList.applyTime=new Date(applyTime);
	 objList.repairContent=repairContent;
	 objList.repairCompany=repairCompany;
	 objList.repairTelephone=repairTelephone;
	 objList.repairFinishedTime=new Date(repairFinishedTime);
	 bootbox.confirm({ 
		  size: "small",
		  message: "确定要保存该折损维修登记信息?", 
		  callback: function(result){
			  if(result){
					$.ajax({
						type : 'POST',
						url : '${ctx}/operationMng/trackRepairApply/save',
...
function update(){
	 ...
	 var flag="false";
	 var objList={};
     var carStockId=$('#ecarStockInfo').val();
     var applyUser=$('#applyUser').val();
     var applyTime=$('#eapplyTime').val();
     var repairContent=$('#erepairContent').val();
     var repairCompany=$('#erepairCompany').val();
     var repairTelephone=$('#erepairTelephone').val();
     var repairFinishedTime=$('#erepairFinishedTime').val();
	 if(carStockId=='' || carStockId==null){
		 bootbox.alert('请选择折损车架号！');
		 return;
	 }
	 ...
	 if(repairCompany=='' || repairCompany==null){
		 bootbox.alert('请输入维修厂信息！');
		 return;
	 }
	 if(repairTelephone=='' || repairTelephone==null){
		 bootbox.alert('请输入维修电话！');
		 return;
	 }
	 if(repairFinishedTime=='' || repairFinishedTime==null){
		 bootbox.alert('请输入预计修好时间！');
		 return;
	 }
	 objList.id=id;
	 ...
	 bootbox.confirm({ 
		  ...
		  callback: function(result){
			  if(result){
					$.ajax({
						type : 'POST',
						url : '${ctx}/operationMng/trackRepairApply/update',
						data : JSON.stringify(objList),
						contentType : "application/json;charset=UTF-8",
						dataType : 'JSON',
						success : function(data) {
...
function finishsave(){
	...
	var finishTime=$('#cfinishTime').val();
	var finishUser=$('#cfinishUser').val();
	if(finishTime=='' || finishTime==null){
		bootbox.alert('取车时间不能为空！');	
		return;
	}
	if(finishUser=='' || finishUser==null){
		bootbox.alert('取车人不能为空！');	
		return;
	}
	bootbox.confirm({ 
		  size: "small",
		  ...
		  callback: function(result){
			  if(result){
				  $.ajax({
						type : 'POST',
						url : '${ctx}/operationMng/trackRepairApply/confirm',
						data : JSON.stringify({
							id : id,
