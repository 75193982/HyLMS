...
<div class="page-content">
	...
	<div class="page-content">
		<div class="searchbox col-xs-12">
		    ...
		    <label class="title" style="float: left;height: 34px;line-height: 34px;width: 105px;">借入开始日期：</label>
		    ...
		    <label class="title" style="float: left;height: 34px;line-height: 34px;margin-right: 13px;width:105px;">借入结束日期</label>
		   <div class="input-group input-group-sm" style="float: left;width: 180px;height:34px; margin-right:30px;margin-left: 5px;">
		...
		<table id="detailtable" class="table table-striped table-bordered table-hover">
				...
				<div class="modal-dialog" style="padding:0;margin:auto;">
				  <div class="modal-content" style="border:0;">
				     <div class="modal-header" style="padding:0 15px;">
					  ...
					  <h3 id="myModalLabel">新增其他应付款信息</h3>
				     </div>
							...
							<div class="widget-body">
							  <div class="widget-main">
								...
								<div class="add-item extra-item" style="position:relative">
								     <label class="title"><span class="red">*</span>借入时间：</label>
								     <div class="input-group input-group-sm w75" style="font-size: 14px; ">
										<input class="form-control" style="font-size: 14px;padding: 5px 4px;" id="operateTime_add" style="height: 32px;" type="text" placeholder="请输借入时间"/>
										<span class="input-group-addon">
											<i class="icon-calendar"></i>
										</span>									
									 </div>
								...
								<div class="add-item extra-item" style="position:relative">
								 ...
								 <hr class="tree"></hr>
								 <div class="add-item extra-item">
									  <label class="title"><span class="red">*</span>借入金额：</label>
									  <input class="form-control" id="amount_add" type="text" placeholder="请输入借入金额" style="height: 32px;" onblur="revaildate(this,0);"/>
								 </div>
								  <hr class="tree"></hr>
								<div class="add-item extra-item" style="position:relative">
								...
								<div class="add-item extra-item" style="position:relative">
							     ...
							     <hr class="tree"></hr>
								 <div class="add-item extra-item">
							        <label class="title">实际应付：</label>
							     	<input class="form-control" id="actualAmount_add" type="text" placeholder="请输入实际应付" style="height: 32px;" readonly="readonly"/>
							    </div>	
							    <hr class="tree"></hr>	
								 <div class="add-item extra-item">
			...
			<div class="modal fade modal_car" id="modal-edit" tabindex="-1" role="dialog"  data-backdrop="static">
				<div class="modal-dialog" style="padding:0;margin:auto;">
				  <div class="modal-content" style="border:0;">
				     <div class="modal-header" style="padding:0 15px;">
					  <button class="close" type="button" data-dismiss="modal">×</button>
					  <h3 id="myModalLabel">编辑其他应付款信息</h3>
				     </div>
					<div class="modal-body" style="padding:5px 20px;">
						  <div class="widget-box dia-widget-box">
							<div class="widget-body">
							  <div class="widget-main">
								...
								<div class="add-item extra-item" style="position:relative">
								     <label class="title"><span class="red">*</span>借入时间：</label>
								     <div class="input-group input-group-sm w75" style="font-size: 14px; ">
										<input class="form-control" style="font-size: 14px;padding: 5px 4px;" id="operateTime_edit" style="height: 32px;" type="text" placeholder="请输入借入时间"/>
										<span class="input-group-addon">
											<i class="icon-calendar"></i>
										</span>									
									 </div>
								...
								<div class="add-item extra-item" style="position:relative">
								 ...
								 <div class="add-item extra-item">
									  <label class="title"><span class="red">*</span>借入金额：</label>
									  <input class="form-control" id="amount_edit" type="text" placeholder="请输入借入金额" style="height: 32px;" onblur="revaildate(this,4);"/>
								 </div>
								 <hr class="tree"></hr>
								<div class="add-item extra-item" style="position:relative">
								...
								<div class="add-item extra-item" style="position:relative">
								 ...
								 <div class="add-item extra-item">
							        <label class="title">实际应付：</label>
							     	<input class="form-control" id="actualAmount_edit" type="text" placeholder="请输入实际应付" style="height: 32px;" readonly="readonly"/>
							    </div>	
							    <hr class="tree"></hr>	
								 <div class="add-item extra-item">
								     <label class="title">备注：</label>
		 ...
		 <div class="modal fade" id="modal-view" tabindex="-1" role="dialog" data-backdrop="static">
				<div class="modal-header">
					<button class="close" type="button" data-dismiss="modal" >×</button>
					<h3 id="myModalLabel" style="margin:5px;">查看其他应付款信息</h3>
				</div>
...
function init(){
	var myTable = $('#detailtable').DataTable({
		 ...
		 "sAjaxSource": "${ctx}/reportMng/payableContacts/getListData" , //获取数据的ajax方法的URL							 
		 "ordering": false,	
			"oLanguage": {
...
function save(){
	...
	bootbox.confirm({ 
		  size: "small",
		  message: "确定要保存该其他应付款信息?", 
		  callback: function(result){
			  if(result){
					$.ajax({
						type : 'POST',
						url : '${ctx}/reportMng/payableContacts/save',
						data : JSON.stringify({
							id:0,
...
function doedit(id)
{
	...
	$.ajax({
		type : 'GET',
		url : "${ctx}/reportMng/payableContacts/getDetailData/"+id,
		contentType : "application/json;charset=UTF-8",
		dataType : 'JSON',
		success : function(data) {
			if (data && data.code == 200) {
...
function dosubmit(id)
{
		...
		bootbox.confirm({ 
			  size: "small",
			  message: "确定要提交该其他应付款信息?", 
			  callback: function(result){
				  if(result){
					  $.ajax({
							type : 'GET',
							url : "${ctx}/reportMng/payableContacts/submit/"+id,
							dataType : 'JSON',
							success : function(data) {
								if (data && data.code == 200) {
									 bootbox.confirm_alert({ 
...
function dodelete(id)
{
	...
	bootbox.confirm({ 
		  size: "small",
		  message: "确定要删除该其他应付款信息?", 
		  callback: function(result){
			  if(result){
				  $.ajax({
						type : 'GET',
						url : "${ctx}/reportMng/payableContacts/delete/"+id,
						dataType : 'JSON',
						success : function(data) {
							if (data && data.code == 200) {
								 bootbox.confirm_alert({ 
	...
	bootbox.confirm({ 
		  ...
		  callback: function(result){
			  if(result){
					$.ajax({
						type : 'POST',
						url : '${ctx}/reportMng/payableContacts/saveLog',
						data : JSON.stringify({
...
function dogetlog(otherContactId){
	var html="";
	 $.ajax({
			type : 'GET',
			url : "${ctx}/reportMng/payableContacts/getLogList/"+otherContactId,
			dataType : 'JSON',
			success : function(data) {
				if (data && data.code == 200) {
...
function printInfo(){
	   ...
	   $.ajax({
		    type : 'POST',
			url : "${ctx}/reportMng/payableContacts/getPrintData",
			data : JSON.stringify({
				operTimeStart : $.trim($('#operTimeStart').val()),
				operTimeEnd :$.trim($('#operTimeEnd').val()),
				operUser :$.trim($('#fom_operUser').val()),
...
function exportInfo()
{
	   ...
	   var form = $('<form action="${ctx}/reportMng/payableContacts/getExportData" method="POST"></form>');
