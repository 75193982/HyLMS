...
@WebAppConfiguration
public class OfficeReminderControllerTest {
	@Autowired
	...
	public void testgetListData() throws Exception{
		...
		String url = "/dailyOffice/officeReminder/getListData";
	...
	public void testsave() throws Exception{
		...
		//mark-备注  
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("mark", "你好，我是进行测试的");

		String josnStr = JSONObject.fromObject(params).toString();
		
		String url = "/dailyOffice/officeReminder/save";
		MockHttpServletRequestBuilder post = MockMvcRequestBuilders.post(url);
		post.content(josnStr)
			.contentType(MediaType.APPLICATION_JSON)
			.accept(MediaType.APPLICATION_JSON)
	...
	public void testgetDetailData() throws Exception{
		//请求参数：json格式
		String url = "/dailyOffice/officeReminder/getDetailData/33";
	...
	public void testupdate() throws Exception{
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("id", 33);
		params.put("mark", "测试测试测试测试");
		String josnStr = JSONObject.fromObject(params).toString();
		
		String url = "/dailyOffice/officeReminder/update";
		MockHttpServletRequestBuilder post = MockMvcRequestBuilders.post(url);
		post.content(josnStr)
			.contentType(MediaType.APPLICATION_JSON)
			.accept(MediaType.APPLICATION_JSON)
	...
	public void testdelete() throws Exception{
		//请求参数：json格式
		String url = "/dailyOffice/officeReminder/delete/33";
		MockHttpServletRequestBuilder get = MockMvcRequestBuilders.get(url);
		mockMvc.perform( get )
		.andExpect( MockMvcResultMatchers.status().isOk() )
		.andDo( MockMvcResultHandlers.print() );
