...
<div class="page-content">
	...
	<div class="page-content">
		<div class="searchbox col-xs-12">	
		    <label class="title" style="float: left;height: 34px;line-height: 34px;width: 75px;">借入日期：</label>
...
function init(){
	...
	$.ajax({
		type : 'POST',
		url : "${ctx}/reportMng/payableContacts/getReportData",
		dataType : 'JSON',
...
function exportInfo()
{
	   ...
	   var form = $('<form action="${ctx}/reportMng/payableContacts/export" method="POST"></form>');
