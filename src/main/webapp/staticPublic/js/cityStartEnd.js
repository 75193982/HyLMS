//运单
//省份
var provinces = ["---请选择省份---","北京市","天津市","上海市","重庆市","河北省","河南省","云南省","辽宁省","黑龙江省","湖南省","安徽省","山东省","新疆维吾尔自治区","江苏省","浙江省","江西省","湖北省","广西壮族","甘肃省","山西省","内蒙古自治区","陕西省","吉林省","福建省","贵州省","广东省","青海省","西藏","四川省","宁夏回族","海南省","台湾省","香港特别行政区","澳门特别行政区"];
//城市
var cities = [
		['---请选择市县---'],
...
//声明获取的省份节点元素  
var province=document.getElementById("startProvince_first");  
//声明获取的城市节点元素  
var city=document.getElementById("startAddress_first"); 

var endProvince = document.getElementById("targetProvince_first");
var endCity = document.getElementById("targetAddress_first");
...
function createCitiesEnd(){ 
	var index = endProvince.selectedIndex;
    endCity.options.length=0;  
    for(var i in cities[index]){  
        var op=new Option(cities[index][i],cities[index][i]);  
        endCity.options.add(op);
    }  
